        ...
        <div class="card">
            ...
            <div class="card-content collpase show">
                <div class="card-body">
                    ...
                    <form action="{{ route('articles.update', $articlesData->id) }}" class="form form-horizontal" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-3 mt-3">
                                        ...
                                        <div class="col-md-9">
                                            <input required type="text" id="title" class="form-control border-primary"
                                                placeholder="title"  value="{{ $articlesData->title }} " name="title">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input required type="text" id="content" class="form-control border-primary"
                                                placeholder="content"  value="{{ $articlesData->content }} " name="content">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3 mt-3">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            placeholder="User image"  value="{{ $articlesData->image }} " name="image">
                                        </div>
                                        <br>
                                        <img src="{{ asset('/upload/' . $articlesData->image) }}" style="width: 100px"/>
                                    </div>
                                </div>
                                <div class="col-md-3 mt-3">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            @foreach ($categoriesData as $data)
                                                <option value="{{ $data->id }}"
                                                    {{ $articlesData->category_id == $data->id ? 'selected' : '' }}>
                                                    {{ $data->name }}</option>
                                            @endforeach
                                        </select>
